...
from cortex_runtime.source_lanes import DOCX_TEXT_LANE, MARKDOWN_LANE, PLAIN_TEXT_LANE, lane_eligibility_for_path
...
def _worker_type_for_path(path: Path, media_type: str | None) -> tuple[str, str]:
    ...
    raise GnatPlanningError("GNAT admits only Markdown, plain-text, PDF text-layer, and DOCX source lanes")
