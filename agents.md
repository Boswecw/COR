...
- supported source path is currently narrow and governed
...
**No default runtime expansion target is implied past Runtime Slice 4 without an explicit user request anchored to v2.1.**
...
- `.md`
- `.txt`
- `.docx` next likely expansion candidate
